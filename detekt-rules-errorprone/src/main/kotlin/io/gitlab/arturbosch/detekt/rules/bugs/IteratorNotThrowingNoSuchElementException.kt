...
class IteratorNotThrowingNoSuchElementException(config: Config) : Rule(config, "The `next()` method of an `Iterator` implementation should throw a `NoSuchElementException` " +
