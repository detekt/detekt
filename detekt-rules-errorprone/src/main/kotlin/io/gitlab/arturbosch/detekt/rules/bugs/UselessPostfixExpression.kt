...
class UselessPostfixExpression(config: Config) : Rule(config, "The incremented or decremented value is unused. This value is replaced with the original value.") {
