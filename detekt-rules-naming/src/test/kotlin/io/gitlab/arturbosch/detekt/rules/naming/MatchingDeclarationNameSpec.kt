...
class MatchingDeclarationNameSpec {
    ...
    inner class FileNameWithoutSuffix {
        ...
        fun `should remove kt suffix`() {
            ...
            Assertions.assertThat(filename).isEqualTo("C")
        }
