...
class FunctionParameterNaming(config: Config) : Rule(config, "Function parameter names should follow the naming convention set in the projects configuration.") {
