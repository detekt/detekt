...
class ConstructorParameterNaming(config: Config) : Rule(config, "Constructor parameter names should follow the naming convention set in the projects configuration.") {
