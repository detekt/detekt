...
class InstanceOfCheckForException(config: Config) : Rule(config, "Instead of catching for a general exception type and checking for a specific exception type, " +
