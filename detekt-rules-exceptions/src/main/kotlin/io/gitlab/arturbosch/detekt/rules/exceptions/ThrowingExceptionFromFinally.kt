...
class ThrowingExceptionFromFinally(config: Config) : Rule(config, "Do not throw an exception within a finally statement. This can discard exceptions and is confusing.") {
