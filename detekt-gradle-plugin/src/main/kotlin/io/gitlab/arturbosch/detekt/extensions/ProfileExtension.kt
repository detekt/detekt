...
open class ProfileExtension(val name: String) {
	...
	open var input: String? = null // No longer needed because sourceSets
	open var config: Any? = null // Takes a TextResource
	open var configResource: String? = null // No need because of TextResource?
	open var filters: String? = null // Yes
	open var ruleSets: String? = null // Ignore
	open var output: String? = null // Test with new DSL
	open var outputName: String? = null // Test with new DSL
	open var baseline: String? = null // Yes
	open var parallel: Boolean = false // Yes
	open var disableDefaultRuleSets: Boolean = false
	open var plugins: String? = null // Yes
