...
import dev.detekt.gradle.plugin.extensions.DetektReportType
import dev.detekt.gradle.plugin.extensions.DetektReports
import dev.detekt.gradle.plugin.extensions.FailOnSeverity
import dev.detekt.gradle.plugin.invoke.AllRulesArgument
import dev.detekt.gradle.plugin.invoke.ApiVersionArgument
import dev.detekt.gradle.plugin.invoke.AutoCorrectArgument
import dev.detekt.gradle.plugin.invoke.BasePathArgument
import dev.detekt.gradle.plugin.invoke.BaselineArgumentOrEmpty
import dev.detekt.gradle.plugin.invoke.BuildUponDefaultConfigArgument
import dev.detekt.gradle.plugin.invoke.ClasspathArgument
import dev.detekt.gradle.plugin.invoke.CliArgument
import dev.detekt.gradle.plugin.invoke.ConfigArgument
import dev.detekt.gradle.plugin.invoke.CustomReportArgument
import dev.detekt.gradle.plugin.invoke.DebugArgument
import dev.detekt.gradle.plugin.invoke.DefaultReportArgument
import dev.detekt.gradle.plugin.invoke.DetektInvoker
import dev.detekt.gradle.plugin.invoke.DetektWorkAction
import dev.detekt.gradle.plugin.invoke.DisableDefaultRuleSetArgument
import dev.detekt.gradle.plugin.invoke.ExplicitApiArgument
import dev.detekt.gradle.plugin.invoke.FailOnSeverityArgument
import dev.detekt.gradle.plugin.invoke.FreeArgs
import dev.detekt.gradle.plugin.invoke.FriendPathArgs
import dev.detekt.gradle.plugin.invoke.InputArgument
import dev.detekt.gradle.plugin.invoke.JdkHomeArgument
import dev.detekt.gradle.plugin.invoke.JvmTargetArgument
import dev.detekt.gradle.plugin.invoke.LanguageVersionArgument
import dev.detekt.gradle.plugin.invoke.MultiPlatformEnabledArgument
import dev.detekt.gradle.plugin.invoke.NoJdkArgument
import dev.detekt.gradle.plugin.invoke.OptInArguments
import dev.detekt.gradle.plugin.invoke.ParallelArgument
