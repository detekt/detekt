package dev.detekt.gradle.plugin.report

import dev.detekt.gradle.plugin.manifestContent
...
class ReportMergeSpec {
    ...
    fun `for jvm detekt`() {
        ...
        val mainBuildFileContent: String = """
            ...
            val reportMerge by tasks.registering(dev.detekt.gradle.plugin.report.ReportMergeTask::class) {
            ...
            subprojects {
                ...
                plugins.withType<dev.detekt.gradle.plugin.DetektPlugin> {
                    tasks.withType<dev.detekt.gradle.plugin.Detekt>().configureEach {
    ...
    @Suppress("LongMethod")
    @Test
    @EnabledIf("dev.detekt.gradle.plugin.DetektAndroidSpecKt#isAndroidSdkInstalled")
