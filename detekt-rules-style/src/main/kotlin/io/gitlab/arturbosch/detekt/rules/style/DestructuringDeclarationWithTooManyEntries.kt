...
class DestructuringDeclarationWithTooManyEntries(config: Config) : Rule(config, "Too many entries in a destructuring declaration make the code hard to understand.") {
