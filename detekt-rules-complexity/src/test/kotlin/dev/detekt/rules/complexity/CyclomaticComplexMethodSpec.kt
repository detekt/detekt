    ...
    inner class `several complex methods` {
        ...
        fun `reports all complex methods`() {
            ...
            assertThat(findings).satisfiesExactlyInAnyOrder(
                ...
                { assertThat(it).hasStartSourceLocation(11, 5) },
                { assertThat(it).hasStartSourceLocation(21, 5) },
                { assertThat(it).hasStartSourceLocation(31, 5) },
                { assertThat(it).hasStartSourceLocation(39, 5) },
            )
        }
