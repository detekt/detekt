...
class FindingsAssert(actual: List<Finding>) :
    ...
    override fun toAssert(value: Finding?, description: String?): FindingAssert = FindingAssert(value).`as`(description)
}
...
private fun String.addPinAt(sourceLocation: SourceLocation): String =
