...
- **[User guide](#user-guide)** — for people consuming detekt through the Gradle plugin or the CLI.
...
|-----------------------|---------------|--------------|
| Gradle                | 6.8.3         | 7.6.3        |
| Android Gradle Plugin | 4.x           | 9.0.0        |
...
[The compiler plugin was removed](#the-compiler-plugin-was-removed).
...
[analysis tasks](#new-and-renamed-gradle-tasks) cover the same source, and with
[`full` analysis](#analysis-modes-light-and-full) they have the same type information the compiler
plugin had.
...
- **Style / complexity** — [#8422](https://github.com/detekt/detekt/pull/8422),
...
- **Naming** — [#8201](https://github.com/detekt/detekt/pull/8201),
  ...
  [#8325](https://github.com/detekt/detekt/pull/8325)

:::tip[Thank you to everyone who migrated a rule]

Porting every type-aware rule off the K1 compiler was the single largest piece of work in the 2.0
cycle, and most of it was done by people volunteering their time. Our thanks to, in alphabetical
order:

[@3flex](https://github.com/3flex),
[@atulgpt](https://github.com/atulgpt),
[@BraisGabin](https://github.com/BraisGabin),
[@brunoescalona](https://github.com/brunoescalona),
[@inorichi](https://github.com/inorichi),
[@marschwar](https://github.com/marschwar),
[@segunfamisa](https://github.com/segunfamisa),
[@t-kameyama](https://github.com/t-kameyama) and
[@travisMiehm](https://github.com/travisMiehm).

The migration was tracked per rule set in
[#8039](https://github.com/detekt/detekt/issues/8039)–[#8046](https://github.com/detekt/detekt/issues/8046).
...
[stricter YAML parsing](#the-yaml-parser-is-stricter-about-types) users see.
