...
| `detekt-psi-utils`                | `detekt-rule-helpers`               |
...
| `io.gitlab.arturbosch.detekt:detekt-psi-utils`         | `dev.detekt:detekt-rule-helpers`              |
| `io.gitlab.arturbosch.detekt.rules` (PSI helpers)      | `dev.detekt.rulehelpers`                      |
