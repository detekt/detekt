...
- [Compose API Guidelines](https://github.com/androidx/androidx/blob/androidx-main/compose/docs/compose-api-guidelines.mdx)
- [Compose source](https://cs.android.com/androidx/platform/frameworks/support/+/androidx-main:compose)

### FunctionNaming for Compose

See [FunctionNaming](../rules/naming.mdx#functionnaming).
...
See [TopLevelPropertyNaming](../rules/naming.mdx#toplevelpropertynaming).
...
See [LongParameterList](../rules/complexity.mdx#longparameterlist).
...
See [MagicNumber](../rules/style.mdx#magicnumber).
...
See [UnusedPrivateFunction](../rules/style.mdx#unusedprivatefunction).
...
See [TooManyFunctions](../rules/complexity.mdx#toomanyfunctions).
