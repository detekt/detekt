...
* ``ignoreClass`` (default: ``['java.io.ByteArrayInputStream', 'java.io.ByteArrayOutputStream']``)

  List of fully qualified class names that should be excluded from this rule (treated as not-closable).
