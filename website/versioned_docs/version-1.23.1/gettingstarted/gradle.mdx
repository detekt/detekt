...
detekt requires **Gradle 6.8.3** or higher. We, however, recommend using the version of Gradle that is [listed in this table](../introduction/compatibility).
...
Instead of disabling detekt for the check task, you may want to increase the build failure threshold in the [configuration file](../introduction/configurations).
