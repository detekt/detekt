...
Which improves McCabe's Cyclomatic Complexity (see [CyclomaticComplexMethod](complexity.mdx#cyclomaticcomplexmethod)) considering the programmer's mental model.
