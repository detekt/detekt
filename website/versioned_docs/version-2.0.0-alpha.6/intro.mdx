...
- Support for different report formats: HTML, Markdown, [SARIF](https://sarifweb.azurewebsites.net/), Checkstyle(XML) and custom reports.
- [Extend detekt](introduction/extensions.mdx) with custom rule sets and reports.
...
See [reporting](introduction/reporting.mdx) docs for more details on configuring reports.
