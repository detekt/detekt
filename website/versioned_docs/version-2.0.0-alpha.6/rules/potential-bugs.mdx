...
Prefer passing [`java.util.Locale`](https://docs.oracle.com/javase/8/docs/api/java/util/Locale.html) explicitly than using implicit default value when formatting
...
[`java.util.Locale.ROOT`](https://docs.oracle.com/javase/8/docs/api/java/util/Locale.html#ROOT) is recommended for machine-readable output.
