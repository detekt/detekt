...
- Support for different report formats: HTML, Markdown, [SARIF](https://sarifweb.azurewebsites.net/), [Checkstyle(XML)](https://checkstyle.sourceforge.io/) and custom reports.
