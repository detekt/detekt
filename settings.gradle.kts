...
dependencyResolutionManagement {
    repositories {
        mavenCentral()
        // This repo can be removed when this is closed: https://youtrack.jetbrains.com/issue/KT-56203/AA-Publish-analysis-api-standalone-and-dependencies-to-Maven-Central
