...
/**
 * See [ktlint docs](https://pinterest.github.io/ktlint/__KTLINT_VERSION__/rules/experimental/#disallow-empty-lines-at-start-of-class-body)
 * for documentation.
 */
...
class NoEmptyFirstLineInClassBody(config: Config) : FormattingRule(config) {
    ...
    override val issue = issueFor("Disallow blank lines at start of a class body.")
