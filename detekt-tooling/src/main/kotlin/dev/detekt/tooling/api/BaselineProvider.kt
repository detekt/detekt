...
interface BaselineProvider {
    ...
    companion object {
        ...
        fun load(classLoader: ClassLoader = BaselineProvider::class.java.classLoader): BaselineProvider =
            ServiceLoader.load(BaselineProvider::class.java, classLoader).first()
    }
}
