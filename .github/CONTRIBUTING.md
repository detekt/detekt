...
- We welcome all sorts of contributions from the community, and using AI tools to assist your PRs is perfectly fine and accepted. 
- However, we do have a special policy for contributions that appear to be **entirely generated by AI**:
  - This includes PRs that we suspect have little to no human scrutiny or review.
  - This applies to both the PR description and code.
  - This applies also to responses posted as review comments that appear to be copied directly from an AI agent without context.
- Those AI-generated contributions can create extra work for maintainers and slow down the contribution process.
- If you use AI to help you write or refine code, tests, or documentation, please ensure that what you submit:
  - Is accurate, idiomatic, and aligned with detekt's contribution guidelines.
  - Reflects your own understanding and intent.
  - Includes meaningful descriptions and justifications in commit messages and PR text.

In short: use AI as a tool, not as a replacement for human context, care, and responsibility. We appreciate your contributions — and your thoughtfulness in how you prepare them.
