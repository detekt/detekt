...
class IgnoreAnnotationSuppressorSpec(private val env: KotlinCoreEnvironment) {

    @Nested
    inner class IgnoreAnnotationSuppressor {
        val suppressor = ignoreAnnotationSuppressorFactory(
